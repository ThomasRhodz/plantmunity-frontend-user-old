...
const DiscoverTab = () => {
  ...
  return ( 
    ...
    <Grid container direction={matches? 'column':'row'} alignItems="center" sx={{ padding: 3, paddingRight:0, paddingLeft: 0, marginTop: {xs:10,sm:10,md:10}, marginLeft: 'auto', marginRight: 'auto', width:{xs:'375',sm:'840px',md:'1300px'} , height: {xs:'100%',sm:'535px',md:'300px'}, bgcolor: 'transparent',  }}>
