...
import { useGetIsFollowingYouQuery } from '../../../app/services/associateApi';
  ...
  return (
    ...
    >
      ...
      <Grid container direction="row" alignItems={mobile ? "" : "center"}>
        ...
        <Grid
          item
          sx={{ width: { xs: "85%", sm: "55%", md: tablet ? "55%" : "70%" } }}
        >
        ...
        <Grid
          item
          sx={{ width: { xs: "100%", sm: "30%", md: tablet ? "30%" : "20%" } }}
        >
